...
--
-- Temporary view structure for view `enabled_users`
--

DROP TABLE IF EXISTS `enabled_users`;
/*!50001 DROP VIEW IF EXISTS `enabled_users`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `enabled_users` AS SELECT 
 1 AS `username`,
 1 AS `email`,
 1 AS `phone`,
 1 AS `creation_dt`,
...
--
-- Final view structure for view `enabled_users`
--
...
-- Dump completed on 2024-09-01 23:40:38
